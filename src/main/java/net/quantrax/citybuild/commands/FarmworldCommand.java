...
public class FarmworldCommand extends BaseCommand {
    ...
    public void onDefault(Player player) {
        Location location = locationCache.get(toml.getString("farmworld-spawn-name"));
        ...
        Messenger.builder(messageCache).sender(player).message("farmworld-teleport").build().send();
    }
